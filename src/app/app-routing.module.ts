...
import { AdminProductAddComponent } from './modules/admin/adminproduct/admin-product-add/admin-product-add.component';
import { AdminProductUpdateComponent } from './modules/admin/adminproduct/admin-product-update/admin-product-update.component';
